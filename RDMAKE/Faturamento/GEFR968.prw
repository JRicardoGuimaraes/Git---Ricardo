		...
		If  cKey <> (cAliasSF3)->F3_NFISCAL+(cAliasSF3)->F3_SERIE+(cAliasSF3)->F3_CLIEFOR+(cAliasSF3)->F3_LOJA .Or. ((cAliasSF3)->(Eof()))
         ...
         aItensSD2 := {}
			...
			For nX := 1 to nCopias
				...
				oPrint:Say(0160,1950,PadC(Alltrim(Alltrim(cF3_NFISCAL) + Iif(!Empty(cF3_SERIE)," / " + Alltrim(cF3_SERIE),"")),15),oFontA10n)
...
//				oPrint:Say(1865,250,Alltrim(STR0043),oFont10n) // "Código do Serviço"
				oPrint:Say(1865,250,Alltrim("Código do Serviço"),oFont10n) // "Código do Serviço"				
			...
			ElseIf lBhorizonte 
				...
				oPrint:Say(2260,290,Transform(nValPis ,PesqPict("SF3","F3_VALICM")),oFont09) 
    			oPrint:Say(2260,650,"COFINS:" ,oFont09)
				oPrint:Say(2260,690,Transform(nValCof ,PesqPict("SF3","F3_VALICM")),oFont09) 
				oPrint:Say(2260,1050,"IR:" ,oFont09)
				oPrint:Say(2260,1090,Transform(nValIR  ,PesqPict("SF3","F3_VALICM")),oFont09) 
				oPrint:Say(2260,1450,"CSLL:" ,oFont09)
				oPrint:Say(2260,1490,Transform(nValCSLL,PesqPict("SF3","F3_VALICM")),oFont09) 
            ...
            If !lBhorizonte
				...
				oPrint:Say(2305,370,Padl(StrZero(Year((cAliasSF3)->F3_EMISSAO),4)+"/"+(cAliasSF3)->F3_NFELETR,14),oFont10)
