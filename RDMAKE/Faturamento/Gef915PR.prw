...
Static oDlg
  ...
  DEFINE MSDIALOG oDlg TITLE "Atualizar RPS com NFE" FROM 000, 000  TO 110, 425 COLORS 0, 16777215 PIXEL
    ...
    @ 017, 010 MSGET oGetRPS VAR cGetRPS SIZE 060, 010 OF oDlg PICTURE "@R 999999999" VALID StrZero(Val(oGetRPS),9) COLORS 0, 16777215 PIXEL
    @ 017, 088 MSGET oGetSerie VAR cGetSerie SIZE 032, 010 OF oDlg PICTURE "!!!" COLORS 0, 16777215 PIXEL
    @ 017, 139 MSGET oGetNFE VAR cGetNFE SIZE 060, 010 OF oDlg PICTURE "@R 99999999" VALID StrZero(Val(oGetNFE),8) COLORS 0, 16777215 PIXEL
    DEFINE SBUTTON oSButton1 FROM 040, 130 TYPE 01 OF oDlg ONSTOP "Confirmar" ENABLE
    DEFINE SBUTTON oSButton2 FROM 040, 180 TYPE 02 OF oDlg ONSTOP "Cancelar" ENABLE
