...
Descricao   : Função Statica - Valida tela
Uso         : Interno
Sintaxe     : fVldTela()
Chamanda    : GEFINSPA7
*/
...
If Empty(M->PA7_CNPJ) .AND. Empty(M->PA7_CLILOJ)  
	Aviso("Aviso","Se o cliente for internacional, o campo Cliente/Loja deve ser preenchido, caso contrátio o CNPJ é obrigatório.",{"Ok"})
	_lRet := .F.
EndIf 		
