...
Static Function Runproc( aDados )
	...
	For Y := 1 To nDados
		...
		AADD( aCampos , { "PA7_NOME"	, SubStr( aDados[Y][03],1,TamSX3("PA7_NOME")[1]		)	} )
		AADD( aCampos , { "PA7_MUN"	 	, SubStr( aDados[Y][04],1,TamSX3("PA7_MUN")[1]		)	} )
		AADD( aCampos , { "PA7_PAIS"	, SubStr( aDados[Y][05],1,TamSX3("PA7_PAIS")[1]		)	} )
		AADD( aCampos , { "PA7_LOCAL"	, SubStr( aDados[Y][06],1,TamSX3("PA7_LOCAL")[1]		)	} )
		AADD( aCampos , { "PA7_CEP"		, StrTran( aDados[Y][07],"-",'' )							} )
		AADD( aCampos , { "PA7_LOCROL"	, SubStr( aDados[Y][08],1,TamSX3("PA7_LOCROL")[1]	)	} )
		AADD( aCampos , { "PA7_PLANT"	, SubStr( aDados[Y][09],1,TamSX3("PA7_PLANT")[1]		)	} )
		AADD( aCampos , { "PA7_CALEND"	, SubStr( aDados[Y][10],1,TamSX3("PA7_CALEND")[1]	)	} )
		AADD( aCampos , { "PA7_UF"		, SubStr( aDados[Y][11],1,TamSX3("PA7_UF")[1]			)	} )
