...
cQry += "       'NFRETEPESO'  = MAX(CASE WHEN DT3_COLIMP = '1' THEN DT3_DESCRI ELSE '' END ), SPACE(100) AS OBS "  // Alterado por: Ricardo - Em: 20/08/12 - Inclusão de colunaSPACE(100) AS OBS "
/*
...
cQry += "       'DESPACHO'    = SUM( CASE WHEN DT3_COLIMP = '8' THEN DT8_VALTOT ELSE 0 END ), "
cQry += "       'OUTROS'      = SUM( CASE WHEN DT3_COLIMP = '9' THEN DT8_VALTOT ELSE 0 END ), "
cQry += "       'NFRETEPESO'  = MAX(CASE WHEN DT3_COLIMP = '1' THEN DT3_DESCRI ELSE '' END ), DTC_CODOBS, SPACE(100) AS OBS, DTC_SELORI "  // Alterado por: Ricardo - Em: 20/08/12 - Inclusão de colunaDTC_SELORI, DTC_CODOBS, SPACE(100) AS OBS "
/*
cQry += " FROM  " + RetSqlName("DT8") + " DT8 LEFT JOIN DTL010 DTL ON DT8_TABFRE = DTL_TABFRE AND DT8_TIPTAB = DTL_TIPTAB, " 
