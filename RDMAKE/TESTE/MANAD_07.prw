...
If NetErr()  // Verifico se foi bem sucedido a abertura do arquivo
	MsgAlert("O arquivo de nome MANAD2008_ORIG nao pode ser aberto! Possível está aberto por outro usuário.","Atencao!")
	Return
Endif
...
dbSelectArea("MANAD")
COPY TO "D:\MANAD_2007_2008\2007\MANAD_2007_2.TXT" SDF
dbCloseArea()
Alert("Arquivo MANAD_2007.TXT copiado.")
Return
...
MSPROCTXT( "Gerando registros I(Contabilização) do MANAD 2008" )
...
COPY TO D:\MANAD_2007_2008\2007\MANAD_2007

dbSelectArea("MANAD") ; dbCloseArea()

dbUseArea(.T.,__LocalDriver,"D:\MANAD_2007_2008\2007\MANAD_2007","MANAD",.F.,.F.)

If NetErr()  // Verifico se foi bem sucedido a abertura do arquivo
	MsgAlert("O arquivo de nome MANAD2008 nao pode ser aberto! Possível está aberto por outro usuário.","Atencao!")
	Return
Endif
...
// Gravo os registros
MSPROCTXT( "Gerando registros I200(Lançamentos Contabil) do MANAD 2008" )
While !Eof()
	...
	*------------------------------------------------------------*
	...
	CTBGerRazT(oMeter,oText,oDlg,.T.,@cArqTmp,I050->CT1_CONTA,I050->CT1_CONTA,"","9999999999",;
			"","999999999","","999999999","01",CTOD("01/01/07"),CTOD("31/12/07"),;
