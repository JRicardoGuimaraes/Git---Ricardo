...
//If (cAliasSE2)->E2_MOEDA <> 1 .and. MV_PAR05 > 0 
//If E2_MOEDA <> 1 .and. MV_PAR05 > 0 
//	//
//	alert("alterei")
//	//
//	//RecLock(cAliasSE2,.F.)
//	//(cAliasSE2)->E2_TXMOEDA := MV_PAR05                     && Ajusto a Moeda Contratada conforme Valor Cotacao
//	E2_TXMOEDA := MV_PAR05                     && Ajusto a Moeda Contratada conforme Valor Cotacao
//    //
//	//MsUnlock()
//	//
//Endif
