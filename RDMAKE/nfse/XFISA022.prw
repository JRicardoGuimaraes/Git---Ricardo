...
_cArqEmp := "\\10.62.160.100\Protheus10\protheus_data_nfse\system\sigamat.emp"
_cArqInd := "\\10.62.160.100\Protheus10\protheus_data_nfse\system\sigamat.ind"
SET DELETED OFF
...
WaitRun("\\10.62.160.100\Protheus10\bin_nfse\smartclient\TotvsSmartClient.exe -m -e=nfse -p=sigafat -c=tcp")
Return

User Function ZFISA022(xEmp,xFil)

// define variaveis
Local _cServer   := "10.62.160.100"
Local _cPorta    := "5671"
