...
//		DEFINE SBUTTON oSButton1 FROM 059, 218 TYPE 01 OF oDlg ONSTOP "Confirmar Informações" ENABLE ACTION u_VldBotao(@cGet1,@cGet2,"1",nCboBox1)
		DEFINE SBUTTON oSButton1 FROM 059, 218 TYPE 01 OF oDlg ONSTOP "Confirmar Informações" ENABLE ACTION u_VldBotao(@cGet1,@cGet2,SubStr(nCboBox1,1,1) )
...
*----------------------------------------------*
User Function VldBotao(cGet1,cGet2, cCBO)
*----------------------------------------------*
	Local aArea	 := GetArea()
