...
Static Function ModelReport
	...
	oSection := TRSection():New(oReport,"UO",/*uTable*/,/*aOrder*/,/*lLoadCells*/,/*lLoadOrder*/,/*uTotalText*/,/*lTotalInLine*/,/*lHeaderPage*/,/*lHeaderBreak*/,/*lPageBreak*/,/*lLineBreak*/,/*nLeftMargin*/,/*lLineStyle*/,/*nColSpace*/,.T.,/*cCharSeparator*/,/*nLinesBefore*/,/*nCols*/,/*nClrBack*/,/*nClrFore*/,/*nPercentage*/)
	...
	oSection:SetTotalText("Total da Geral :" )

	TRCell():New(oSection,"UO"	,"dTRABDB","UO"					,'@!'												,06												, .T.,/*{|| }*/,,,"Left")
...
//			oSection := oReport:Section(Z)
			...
			oReport:SetTitle('RELATORIO DE PDD' + IIf( MV_PAR04 == 1 ," ANALITICO"," SINTETICO" ) )
