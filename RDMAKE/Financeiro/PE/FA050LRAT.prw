...
ฑฑบPrograma  F050LRAT  บAutor  ณ    Marcos Furtado   บ Data ณ  24/08/06   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Ponto de Entrada executado na grava็ใo (Inclusใo) do tituloบฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
If (Empty(GdFieldGet("CTJ_DEBITO")) .And. Empty(GdFieldGet("CTJ_CREDIT"))) .Or. ;
   ...
   Empty(GdFieldGet("CTJ_HIST")) 
	lRet  := .F.   
	MsgInfo("Todas as Informa็๕es devem ser preenchidas!","Rateio CC - CP")
EndIF                                                                      
