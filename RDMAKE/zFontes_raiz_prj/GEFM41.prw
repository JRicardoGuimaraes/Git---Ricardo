...
±±ºPrograma  ³GEFM41    º Autor ³ AP6 IDE            º Data ³  21/03/05   º±±
...
cInd := CriaTrab(NIL,.F.)
dbSelectArea("SE1")
IndRegua(cString,cInd,"E1_NUM+E1_PREFIXO+E1_PARCELA+E1_TIPO+E1_FILIAL",,,"Selecionando Registros...")
