...
oPrint:Line (nRow0+0150,500,nRow0+0070, 500)
oPrint:Line (nRow0+0150,710,nRow0+0070, 710)

oPrint:Say  (nRow0+0084,100,aDadosBanco[2],oFont14 )      	 // [2]Nome do Banco
oPrint:Say  (nRow0+0075,513,aDadosBanco[1]+"-7",oFont21 )	 // [1]Numero do Banco

oPrint:Say  (nRow0+0084,1900,"Comprovante de Entrega",oFont10)
oPrint:Line (nRow0+0150,100,nRow0+0150,2300)

oPrint:Say  (nRow0+0150,100 ,"Cedente",oFont8)
oPrint:Say  (nRow0+0200,100 ,aDadosEmp[1],oFont10)				//Nome + CNPJ

oPrint:Say  (nRow0+0150,1060,"Agência/Código Cedente",oFont8)
oPrint:Say  (nRow0+0200,1060,aDadosBanco[3]+"/"+aDadosBanco[4]+"-"+aDadosBanco[5],oFont10)

oPrint:Say  (nRow0+0150,1510,"Nro.Documento",oFont8)
oPrint:Say  (nRow0+0200,1510,aDadosTit[7]+aDadosTit[1],oFont10) //Prefixo +Numero+Parcela

oPrint:Say  (nRow0+0250,100 ,"Sacado",oFont8)
oPrint:Say  (nRow0+0300,100 ,aDatSacado[1],oFont10)				//Nome

oPrint:Say  (nRow0+0250,1060,"Vencimento",oFont8)
oPrint:Say  (nRow0+0300,1060,StrZero(Day(aDadosTit[4]),2) +"/"+ StrZero(Month(aDadosTit[4]),2) +"/"+ Right(Str(Year(aDadosTit[4])),4),oFont10)

oPrint:Say  (nRow0+0250,1510,"Valor do Documento",oFont8)
oPrint:Say  (nRow0+0300,1550,AllTrim(Transform(aDadosTit[5],"@E 999,999,999.99")),oFont10)

oPrint:Say  (nRow0+0400,0100,"Recebi(emos) o bloqueto/título",oFont10)
oPrint:Say  (nRow0+0450,0100,"com as características acima.",oFont10)
oPrint:Say  (nRow0+0350,1060,"Data",oFont8)
oPrint:Say  (nRow0+0350,1410,"Assinatura",oFont8)
oPrint:Say  (nRow0+0450,1060,"Data",oFont8)
oPrint:Say  (nRow0+0450,1410,"Entregador",oFont8)

oPrint:Line (nRow0+0250, 100,nRow0+0250,1900 )
oPrint:Line (nRow0+0350, 100,nRow0+0350,1900 )
oPrint:Line (nRow0+0450,1050,nRow0+0450,1900 ) //---
oPrint:Line (nRow0+0550, 100,nRow0+0550,2300 )

oPrint:Line (nRow0+0550,1050,nRow0+0150,1050 )
oPrint:Line (nRow0+0550,1400,nRow0+0350,1400 )
oPrint:Line (nRow0+0350,1500,nRow0+0150,1500 ) //--
oPrint:Line (nRow0+0550,1900,nRow0+0150,1900 )

oPrint:Say  (nRow0+0165,1910,"(  )Mudou-se"                                	,oFont8)
oPrint:Say  (nRow0+0205,1910,"(  )Ausente"                                    ,oFont8)
oPrint:Say  (nRow0+0245,1910,"(  )Não existe nº indicado"                  	,oFont8)
oPrint:Say  (nRow0+0285,1910,"(  )Recusado"                                	,oFont8)
oPrint:Say  (nRow0+0325,1910,"(  )Não procurado"                              ,oFont8)
oPrint:Say  (nRow0+0365,1910,"(  )Endereço insuficiente"                  	,oFont8)
oPrint:Say  (nRow0+0405,1910,"(  )Desconhecido"                            	,oFont8)
oPrint:Say  (nRow0+0445,1910,"(  )Falecido"                                   ,oFont8)
oPrint:Say  (nRow0+0485,1910,"(  )Outros(anotar no verso)"                  	,oFont8)
*/
...
oPrint:Say  (nRow0+0025,100,aDadosEmp[1],oFont21 )   
oPrint:Say  (nRow0+0125,100,Alltrim(aDadosEmp[2])+Alltrim(aDadosEmp[3])+Alltrim(aDadosEmp[4])+Alltrim(aDadosEmp[5])+Alltrim(aDadosEmp[6]),oFont10 )	 
...
oPrint:Say  (nRow1+0084,1900,"Recibo do Sacado",oFont14)
...
oPrint:Say  (nRow1+0350,0100,aDatSacado[3],oFont10)
oPrint:Say  (nRow1+0400,0100,aDatSacado[6]+"    "+aDatSacado[4]+" - "+aDatSacado[5],oFont10) // CEP+Cidade+Estado

if aDatSacado[8] = "J"
	oPrint:Say  (nRow1+0350,1060,"CNPJ: "+TRANSFORM(aDatSacado[7],"@R 99.999.999/9999-99"),oFont10) // CGC
Else
	oPrint:Say  (nRow1+0350,1060,"CPF: "+TRANSFORM(aDatSacado[7],"@R 999.999.999-99"),oFont10) 	// CPF
EndIf



//oPrint:Say  (nRow1+0450,0100,Substr(aDadosTit[6],1,3)+Substr(aDadosTit[6],4)  ,oFont10)
...
oPrint:Say  (nRow3+2015,400 ,"ATÉ O VENCIMENTO, PAGÁVEL EM QUALQUER AGÊNCIA BANCÁRIA ",oFont10)
...
oPrint:Say  (nRow3+2140,100 ,aDadosEmp[1],oFont10) //Nome 
